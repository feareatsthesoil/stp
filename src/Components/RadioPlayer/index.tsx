...
export default function RadioPlayer() {
  const { playing, toggle, volume, setVolume, current, metadata } =
    ...
    <>
      ...
      >
        ...
        <Grid xs={12} item sx={{ textAlign: "center!important" }}>
          <Button onClick={toggle} className="smMobile:mt-0">
            <FontAwesomeIcon
              size="2x"
        ...
        <Grid
          item
          xs={10}
          sx={{ alignItems: "center !important", maxWidth: "400px !important" }}
        >
