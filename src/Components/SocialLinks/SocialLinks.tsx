...
import index from "./SocialLinks.module.css";
...
const SocialLinks: React.FC<SocialLinksProps> = ({ eventId }) => {
    ...
    return (
        <div className={`${index.wrapper} ${isMobile ? index.mobile : index.desktop} ${isExpanded ? index.expanded : ''}`}>
            ...
            <div className={index.container}>
                {isMobile && isExpanded && (
                    <button className={index.closeButton} onClick={handleClose}>
                        X
                    </button>
                )}
                <TwitterShareButton
