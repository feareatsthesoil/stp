...
export default function DirectoryPage({
  ...
  const handleClick = () => {
    if (!loggedIn) {
      return confirm({
        title: "Please log in",
        description: "Please log in to submit to the directory.",
      ...
      return confirm({
        title: "Members only",
        description: "Please get a membership to submit to the directory.",
            ...
            <div className={css.header}>
              ...
              <Box>
                <Alert color="warning">
                  ...
                  <AlertTitle>
                    Please log in to see the directory. Log in{" "}
                    <Link href="/login?redirect_url=/directory">here</Link>.
                  </AlertTitle>
                </Alert>
              </Box>
            </div>
            ...
            >
              ...
              <Box>
                <Alert color="warning">
                  ...
                  <AlertTitle>
                    You must be a member to see the directory. Sign up{" "}
