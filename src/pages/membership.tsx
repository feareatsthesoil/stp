...
const Membership = () => {
  ...
  return (
    <DefaultLayout>
      <div className="my-4 [&>div]:flex [&>div]:max-w-[1000px] [&>div]:flex-col">
        <div>
        ...
        <div>
          <div className="mt-2 flex items-center justify-between">
            <h1 className="font-bold">Make a tax-deductible donation today.</h1>
            <div>
              <Button
                sx={{
                  backgroundColor: "rgb(239, 239, 239) !important",
          ...
          <p className="pt-2">
            ...
            range of resources and opportunies to artists. There include access
            to a community of fellow artists and supporters, as well as
            workshops, mentorship, events, and strengthen the arts community as
            a whole.
          </p>
        </div>
      </div>
